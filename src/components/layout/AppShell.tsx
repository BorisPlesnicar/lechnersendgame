  ...
  return (
    <div className="flex min-h-dvh flex-col">
      <header className="sticky top-0 z-20 shrink-0 border-b border-zinc-200/60 bg-white/75 px-4 py-4 pt-[max(1rem,env(safe-area-inset-top))] shadow-[0_1px_0_0_rgb(255_255_255_/_0.6)_inset] backdrop-blur-2xl dark:border-zinc-800/70 dark:bg-zinc-950/70 dark:shadow-[0_1px_0_0_rgb(39_39_42_/_0.4)_inset]">
        <div className="mx-auto flex w-full max-w-md flex-col gap-3 sm:max-w-3xl">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-[24rem] text-pretty text-xs leading-relaxed text-zinc-500 dark:text-zinc-400">
      ...
      <main className="mx-auto w-full max-w-md flex-1 px-4 pt-6 pb-[max(9rem,calc(env(safe-area-inset-bottom)+8rem))] sm:max-w-3xl sm:px-5 sm:pt-8 sm:pb-[max(3rem,env(safe-area-inset-bottom))]">
        {children}
      </main>
    </div>
  );
